...
def _merge_x5_public_features(
    ...
    ext["period_start"] = pd.to_datetime(ext["period_start"])
...
def _prepare(train_path, target_transform, winsorize_quantile, feature_groups=None, feature_allowlist=None):
